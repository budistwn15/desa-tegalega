...
<head>
    ...
    <title>Administrasi - Pemerintah Desa Tegalega</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 py-5 mt-5 text-white">
                    <h2 class="display-5">Administrasi Desa</h2>
                    <hr>
    ...
    <section class="wrapper p-5">
        <div class="container">
            <div class="row">
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM him_administrasi ORDER BY id_administrasi");
                if (mysqli_num_rows($query) > 0) {
                    foreach ($query as $data) {
                ?>
                        <div class="col-md-4 mb-3">
                            <div class="card text-center p-5 border-0 bg-success text-white">
                                <h4 class="card-title"><?= $data['judul_administrasi'] ?></h4>
                            </div>
                        </div>
                    <?php
                    }
