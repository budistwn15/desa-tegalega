...
<head>
    ...
    <title>Geografis - Pemerintah Desa Tegalega</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" data-aos="fade-right">
                    ...
                    $query = mysqli_query($koneksi, "SELECT title_geografis,geografis FROM him_geografis WHERE id_geografis=1");
                    $data = mysqli_fetch_array($query);
                    ?>
                    <h2 class="wrapper-title text-success fw-bold">
                        <?= $data['title_geografis'] ?>
                    </h2>
                    <hr class="mb-5">
                    <div>
                        <?= $data['geografis'] ?>
