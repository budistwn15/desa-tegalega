...
<head>
    ...
    <title>Pemerintahan Desa - Pemerintah Desa Tegalega</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 py-5 mt-5 text-white">
                    <h2 class="display-5">Pemerintah Desa</h2>
                    <hr>
                </div>
            </div>
    </section>
    ...
    <section class="wrapper p-5">
        <div class="container">
            <div class="row">
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM him_pemerintahan_desa ORDER BY id_pemerintahan_desa");
                ...
                ?>
                        <div class="col-md-4 mb-3">
                            <div class="card text-center p-5 border-0">
                                ...
                                <p class="pemerintah-title"><?= $data['nama_lengkap'] ?></p>
                            </div>
                        </div>
                    <?php
                    }
